  ...
  return (
    <div id="story" className="min-h-dvh w-screen bg-black text-blue-50">
      <div className="flex flex-col size-full items-center py-10 pb-24">
        <p className="uppercase font-general text-sm md:text-[10px]">
          the multiversal ip world
        </p>
        <div className="relative size-full">
          <AnimatedTitle
            title="The st<b>o<b/>ry of <br/> a hidden re<b>a<b/>lm"
            sectionId="#story"
        ...
        <div className="-mt-24 flex w-full justify-center md:-mt-64 md:me-44 md:justify-end">
